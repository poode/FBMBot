module.exports = {
    // server port you will use and set in ngrok http port command (if you will use ngrok)
    port: `3000`,

    // stringToken will be a token you will use here and in facebook APP, you can use any
    stringToken: `hlknfbkl$#^8795WKJVNSNJF`,

    // API_AI_TOKEN is Dialogflow token. you can get from gear icon beside you app name on left of the page above.
